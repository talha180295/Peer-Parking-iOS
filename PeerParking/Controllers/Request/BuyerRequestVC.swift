...
class BuyerRequestVC: UIViewController ,IndicatorInfoProvider ,  ViewOfferProtocol ,UITableViewDataSource,UITableViewDelegate {
    ...
    //Outlets
    @IBOutlet weak var buyerRequestTbl: UITableView!
    ...
    override func viewDidLoad() {
        ...
        buyerRequestTbl.register(UINib(nibName: "RequestCell", bundle: nil), forCellReuseIdentifier: "RequestCell")
    ...
    func getAllRequest() {
        ...
        var ref  : DatabaseReference! =  buyerRequestIndexReference
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        ...
        return IndicatorInfo(title: "BUYER", accessibilityLabel: "BUYER", image: UIImage(named: "upcomingUn"), highlightedImage: UIImage(named: "upcoming"), userInfo: nil)
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        let cell = buyerRequestTbl.dequeueReusableCell(withIdentifier: "RequestCell") as! RequestCell
        cell.delegate = self
